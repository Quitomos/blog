...
<div id="content">
    ...
    <ul id="contentTable">
        <li>
            ...
            <div class="T2-h pull-right">Last Changed</div>
            <div class="T3-h pull-right">Created Time</div>
            <div class="T4-h pull-right">Views</div>
        </li>
        <div class="clear"></div>
<#--        <li>-->
        ...
        <#if posts?? && posts?size gt 0>
            <#list posts as post>
                <li>
                    ...
                    <div class="T2 pull-right">${post.updateTime?string('yyyy-MM-dd')}</div>
                    <div class="T3 pull-right">${post.createTime?string('yyyy-MM-dd')}</div>
                    <div class="T4 pull-right">${post.visits}</div>
                </li>
                <div class="clear"></div>
            </#list>
        </#if>
...
<div id="content">
    ...
    <ul id="contentTable">
        <li>
            <div class="T1-h pull-left">URL</div>
            <div class="T2-h pull-right">Post Counts</div>
        </li>
        <div class="clear"></div>
        <@categoryTag method="list" contextPath=''>
            <#if categories?? && categories?size gt 0>
                <#list categories as category>
                    <li>
                        ...
                        <div class="T2 pull-right">${category.postCount}</div>
                    </li>
                    <div class="clear"></div>
                    <#if category.childList?has_content>
                        <#list category.childList as child>
                            <li>
                                <div class="T1 pull-left"><a href="<#if !globalAbsolutePathEnabled!true>${blog_url!}</#if>${child.fullPath!}" title="${child.name}">---${child.name} | ${blog_title!}</a></div>
                                <div class="T2 pull-right">${child.postCount}</div>
                            </li>
                            <div class="clear"></div>
                        </#list>
                    </#if>
...
<div id="content">
    ...
    <ul id="contentTable">
        ...
        <@tagTag method="list" contextPath=''>
            <#if tags?? && tags?size gt 0>
                <#list tags as tag>
                    <li>
                        ...
                        <div class="T2 pull-right">${tag.postCount}</div>
                    </li>
                    <div class="clear"></div>
                </#list>
            </#if>
