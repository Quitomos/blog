...
<style type="text/css">
    ...
    */
    ...
    /** 鼠标样式 */
    a {
        cursor: url(${res_base_url!}/source/cursor/link.cur), auto
    }

    a:active {
	    cursor: url(${res_base_url!}/source/cursor/work.ani),alias
    }
    ...
    .cd-top {
        cursor: url(${res_base_url!}/source/cursor/Alternative.cur),auto;
    }

    .botui-actions-buttons-button {
        cursor: url(${res_base_url!}/source/cursor/precision),auto;
    }
    ...
    <#if (settings.list_type!'square') == 'square'>
    .feature img {
    ...
    .at_button {
        ...
        color: ${(settings.journal_color_font_1)!'#000000'};
    }

    .at_button:hover {
        background: ${(settings.journal_color_bg_2)!'#F0FFFF'};
        color: ${(settings.journal_color_font_2)!'#000000'};
    }
    ...
    body.dark .aplayer .aplayer-list ol li:hover {
        background: ${settings.theme_dark!'#FE9600'} !important;
    }
    ...
    body.dark .site-top ul li a:after  {
        background-color: ${settings.theme_dark!'#FE9600'};
    }
    ...
    body.dark .focusinfo .header-tou img  {
        box-shadow: inset 0 0 10px ${settings.theme_dark!'#FE9600'};
    }
</style>
<!-- 黑夜模式评论模块 -->
