...
<head>
	...
	<@global.head />
	<link rel='stylesheet' href='${res_base_url!}/styles/style.min.css?ver=1.3.1' type='text/css' media='all'>
	...
	<link rel='stylesheet' href="${res_base_url!}/source/css/highlight/highlight-${settings.code_pretty!'Dracula'}.css" type="text/css" media="noexist" onload="this.media='all'">
...
<section id="main-container">
    <#if settings.head_focus!true>
		<div class="headertop ${settings.focus_img_filter!'filter-grid'}">
