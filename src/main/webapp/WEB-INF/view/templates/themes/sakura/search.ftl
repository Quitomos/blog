	...
	<#if (settings.patternimg!true) && (settings.searh_patternimg?? && settings.searh_patternimg!='') || ((metas.ri?boolean)!true && settings.rimage_cover_sheet_open!true && settings.rimage_url?? && settings.rimage_url!='')>
		<div class="pattern-center">
			<div class="pattern-attachment-img">
                ...
                <img data-src="${res_base_url + settings.searh_patternimg!}" src="${res_base_url!}/img/svg/loader/orange.progress-bar-stripe-loader.svg" class="lazyload" onerror="imgError(this)">
<#--                <#else>-->
<#--					<img-->
	...
	<#if posts?? && posts.content?size gt 0>
		<main id="main" class="site-main" role="main">
			...
			<header class="page-header">
				<h1 class="page-title"><span>搜索结果： </span><span>${keyword!}</span></h1>
			</header><!-- .page-header -->
			</#if>
