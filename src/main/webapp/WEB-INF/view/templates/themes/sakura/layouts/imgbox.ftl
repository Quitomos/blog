<figure id="centerbg" class="centerbg" style="background-image: url(
	...
	<#else>
	${settings.focus_img_1!'${res_base_url!}/img/hd.jpg'}
	</#if>
	);
...
">
	...
	<div class="focusinfo">
		<#if settings.focus_tou == "avatar">
			...
			<#else>
			<div class="header-tou" ><a href="${blog_url!}"><img src="${res_base_url!}/img/avatar.jpg"></a></div>
			</#if>
		...
		<div class="header-info">
			<#if settings.description?default("")?trim?length gt 1>
			<p><i class="fa fa-quote-left"></i>${settings.description}<i class="fa fa-quote-right"></i></p>
			</#if>
			<div class="top-social_v2">
			    <li id="bg-pre">
            		<img class="flipx" src="${res_base_url!}/img/next-b.svg">
          		</li>
<#--			<#if settings.wechat??>-->
<#--				<li class="wechat"><a href="#">-->
<#--					<img src="${res_base_url!}/img/sns/wechat.png"/></a>-->
...
<#--						<img src="${res_base_url!}/img/sns/sina.png"/>-->
<#--					</a>-->
<#--				</li>-->
<#--			</#if>-->
<#--			<#if settings.qq??>-->
...
<#--						<img src="${res_base_url!}/img/sns/qq.png"/>-->
<#--					</a>-->
<#--				</li>-->
<#--			</#if>-->
<#--			<#if settings.qzone??>-->
...
<#--						<img src="${res_base_url!}/img/sns/qzone.png"/>-->
<#--					</a>-->
<#--				</li>-->
<#--			</#if>-->
<#--			<#if settings.github??>-->
...
<#--						<img src="${res_base_url!}/img/sns/github.png"/>-->
<#--					</a>-->
<#--				</li>-->
<#--			</#if>-->
<#--			<#if settings.lofter??>-->
...
<#--						<img src="${res_base_url!}/img/sns/lofter.png"/>-->
<#--					</a>-->
<#--				</li>-->
<#--			</#if>-->
<#--			<#if settings.bili??>-->
...
<#--						<img src="${res_base_url!}/img/sns/bilibili.png"/>-->
<#--					</a>-->
<#--				</li>-->
<#--			</#if>-->
...
<#--						<img src="${res_base_url!}/img/sns/wangyiyun.png"/>-->
<#--					</a>-->
<#--				</li>-->
<#--			</#if>-->
<#--			<#if settings.twitter??>-->
...
<#--						<img src="${res_base_url!}/img/sns/twitter.png"/>-->
<#--					</a>-->
<#--				</li>-->
<#--			</#if>-->
...
<#--						<img src="${res_base_url!}/img/sns/facebook.png"/>-->
<#--					</a>-->
<#--				</li>-->
<#--			</#if>-->
...
<#--						<img src="${res_base_url!}/img/sns/googleplus.png"/>-->
<#--					</a>-->
<#--				</li>-->
<#--			</#if>-->
<#--			<#if settings.jianshu??>-->
...
<#--						<img src="${res_base_url!}/img/sns/jianshu.png"/>-->
<#--					</a>-->
<#--				</li>-->
<#--			</#if>-->
<#--			<#if settings.zhihu??>-->
...
<#--						<img src="${res_base_url!}/img/sns/zhihu.png"/>-->
<#--					</a>-->
<#--				</li>-->
<#--			</#if>-->
<#--			<#if settings.csdn??>-->
...
<#--						<img src="${res_base_url!}/img/sns/csdn.png"/>-->
<#--					</a>-->
<#--				</li>-->
<#--			</#if>-->
...
<#--						<img src="${res_base_url!}/img/sns/telegram.svg"/>-->
<#--					</a>-->
<#--				</li>-->
<#--			</#if>-->
<#--			<#if settings.email??>-->
...
<#--						<img src="${res_base_url!}/img/sns/email.svg"/>-->
<#--					</a>-->
<#--				</li>-->
<#--			</#if>-->
...
<#--						<img src="${res_base_url!}/img/sns/stackoverflow.svg"/>-->
<#--					</a>-->
<#--				</li>-->
<#--			</#if>-->
<#--				-->
...
<#--				</#if>-->
				<#list accounts as account>
					<li>
						<a href="${account.accountUrl}" target="_blank" title="${account.accountTitle}">
							<img src="${account.accountIcon}"/>
						</a>
					</li>
				</#list>
				...
				<li id="bg-next">
            		<img src="${res_base_url!}/img/next-b.svg">
          		</li>
			</div>
		</div>
	</div>
