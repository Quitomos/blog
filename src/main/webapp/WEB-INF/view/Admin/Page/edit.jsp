        ...
        <div class="layui-col-md4">
            ...
            <form class="layui-form"  method="post" id="myForm" action="${pageContext.request.contextPath}/admin/page/insertSubmit">
                <div class="layui-form-item">
                    ...
                    <input type="hidden" name="pageImage" id="pageImage" value="${page.pageImage}">
                    <br>
                    <div class="layui-input-block">
                        标题 <span style="color: #FF5722; ">*</span>
                        <input type="text" name="pageTitle" id="pageTitle"
                               value="${page.pageTitle}" autocomplete="off" class="layui-input" required>
                    </div>
                    <br>
                    <div class="layui-input-block">
                        超链接
                        <input type="text" name="pageUrl" id="pageUrl"
                               value="${page.pageUrl}" autocomplete="off" class="layui-input">
                    </div>
                    <br>
                    <div class="layui-input-block">
                        超链接target
                        <input type="text" name="pageTarget" id="pageTarget"
                               value="${page.pageTarget}" autocomplete="off" class="layui-input">
                    </div>
                    <br>
                    <div class="layui-input-block">
                        描述
                        <input type="text" name="pageDescription" id="pageDescription"
                               value="${page.pageDescription}" autocomplete="off" class="layui-input">
                    </div>
                    <br>
                    <div class="layui-input-block">
                        order
                        <input type="text" name="pageOrder" id="pageOrder"
                               value="${page.pageOrder}" autocomplete="off" class="layui-input">
                    </div>
                    <br>
                    <div class="layui-input-block">
