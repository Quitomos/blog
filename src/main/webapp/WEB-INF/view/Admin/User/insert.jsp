    ...
    <form class="layui-form" action="${pageContext.request.contextPath}/admin/user/insertSubmit" id="userForm"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="email" name="userEmail" id="userEmail" required
                       ...
                       autocomplete="false" class="layui-input" onblur="checkUserEmail()">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="radio" name="userRole" value="1" title="标准" checked>
                <input type="radio" name="userRole" value="0" title="管理员">
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-input-block">
