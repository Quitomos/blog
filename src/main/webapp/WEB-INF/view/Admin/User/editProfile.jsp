...
<rapid:override name="content">
    ...
    <form class="layui-form" action="/admin/profile/save" id="userForm"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="password" name="userPass" value="${backUser.userPass}" id="userPass" required
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="url" name="userUrl" value="${backUser.userUrl}" placeholder="" autocomplete="off"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
