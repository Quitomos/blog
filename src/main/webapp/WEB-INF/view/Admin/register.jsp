...
<html xmlns="http://www.w3.org/1999/xhtml" lang="zh-CN">
    ...
    <html xmlns="http://www.w3.org/1999/xhtml" lang="zh-CN">
        <head>
            ...
            <title>${option.optionSiteTitle} &lsaquo; 注册</title>
        ...
        <body class="login login-action-login wp-core-ui  locale-zh-cn">
            <div id="login">
                ...
                <p id="backtoblog"><a href="${pageContext.request.contextPath}/">&larr; 返回首页</a> | <a href="${pageContext.request.contextPath}/login">登录</a></p>
